...
A binary gender classification system that applies **KNN**, **Decision Tree**, and **Naive Bayes** to a labeled face image dataset, evaluates each model with confusion matrices, compares their performance, and serves predictions through a **Flask web interface**.
...
|---|---|---|
| ![KNN CM](static/cm_knn.png) | ![DT CM](static/cm_dt.png) | ![NB CM](static/cm_nb.png) |
